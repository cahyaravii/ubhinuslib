...
const books = [
    ...
    { 
        title: "Belajar MS WOrd 2012", 
        link: "https://drive.google.com/file/d/1zWj3C3gSXtyy15IAo3W3vxQdZFpDWuxj/preview", 
        thumbnail: "img/belajarmsword2010.jpg"
    },
    { 
        title: "Panduan Merakit Komputer", 
        link: "https://drive.google.com/file/d/1N12HOhNo5RLlBff6VH8n6q2Z0A6sXqLM/preview", 
        thumbnail: "img/bukumerakitkomputer.jpg"
    },
    { 
        title: "Analysis and Design Using MATLAB", 
        link: "https://drive.google.com/file/d/16-wrtZjN27V0Taqvjg6xGG8PIIB4twKh/preview", 
        thumbnail: "img/designmatlab.jpg"
    },
    { 
        title: "Bikin Game Anti Ribet", 
        link: "https://drive.google.com/file/d/1XgRaa5lz68DpDLtHaaOJxuYEL4__69f-/preview", 
        thumbnail: "img/bikingameantiribet.jpg"
    },
    { 
        title: "Linux Fundamentals", 
        link: "https://drive.google.com/file/d/1d5K8jpTe4glHV__QU9VIcBlUaCsHWupy/preview", 
        thumbnail: "img/linuxfundamental.jpg"
    },
    { 
        title: "Mikrotik Kungfu Kitab 1", 
        link: "https://drive.google.com/file/d/177WNgCcn7Rd2VdEUN4iXiyPyIdk-CQq5/preview", 
        thumbnail: "img/mikrokitkungfu.jpg"
    },
    { 
        title: "Object Oriented Programming Using C#", 
        link: "https://drive.google.com/file/d/1YMSd_Tde6NY1Nfd1Yb9IRNzmLezLLKbM/preview", 
        thumbnail: "img/oopc.jpg"
    },
    { 
        title: "Peran Teknologi Dalam Pembangunan", 
        link: "https://drive.google.com/file/d/1nPJjOSB89XAw2PuHRe8hOf3VgXTkxI9d/preview", 
        thumbnail: "img/teknologimembangun.jpg"
    },
    { 
        title: "Dasar Pemrograman Rust", 
        link: "https://drive.google.com/file/d/1MJbtAVxZlcM4x_56GbzOH-4RZUxUvpdO/preview", 
        thumbnail: "img/dasarpemrogramanrust.jpg"
    },
    { 
        title: "Software Development, Design and Coding", 
        link: "https://drive.google.com/file/d/1W7-WexYbWpVFo1_gc9hsCJKbVu3aw4XH/preview", 
        thumbnail: "img/softwareandcoding.jpg"
    },
    { 
        title: "Deep Learning for Natural Language Processing", 
        link: "https://drive.google.com/file/d/1XxGvYDxf-092Ag1C0Y81nFsjLJyLAddz/preview", 
        thumbnail: "img/Deepnlp.jpg"
    },
    { 
        title: "Practical Machine Learning and Image Processing", 
        link: "https://drive.google.com/file/d/1tiD7P9QxNxZswRvjOxmBY8SpCpvSsTKD/preview", 
        thumbnail: "img/pmlandip.jpg"
    },
    { 
        title: "Java Server Pages Tutorial", 
        link: "https://drive.google.com/file/d/1e_N-YdX8P4maiqZa03fQUmKSdXorspNq/preview", 
        thumbnail: "img/javaservertutor.jpg"
    },
    { 
        title: "Cryptography", 
        link: "https://drive.google.com/file/d/1KMw-uepxSgQmvraS9AIHV0jY0o_BKukj/preview", 
        thumbnail: "img/cryptography.jpg"
    },
    { 
        title: "Boundary Values and Convolution in Ultradistribution Spaces", 
        link: "https://drive.google.com/file/d/1w3UixZfePjrzDwAA5ldtTyjYA4hO9ox2/preview", 
        thumbnail: "img/boundaryvalues.jpg"
    },
    { 
        title: "Islam dan Teknologi", 
        link: "https://drive.google.com/file/d/1mNXI0tOn_AcEELy7ua_wyUc34L_V4X8z/preview", 
        thumbnail: "img/islamteknologi.jpg"
    },
    { 
        title: " Linear Algebra", 
        link: "https://drive.google.com/file/d/1TmgkBO_hnHOXvGrVfBHiDvnNwXMyhetM/preview", 
        thumbnail: "img/algebra.jpg"
    },
    { 
        title: "Problems Based Course in Advanced Calculus", 
        link: "https://drive.google.com/file/d/1iG9oAcQwV99QH_aIOOcebrxTd5TGLVE4/preview", 
        thumbnail: "img/calculus.jpg"
    }
...
function renderBooks(booksToRender) {
    ...
    booksToRender.forEach(book => {
        ...
        card.innerHTML = `
            ...
            <h3>${book.title}</h3>
        `;
        card.addEventListener("click", () => openPDF(book.link));
        container.appendChild(card);
    });
}
...
function closePDF() {
    const overlay = document.getElementById("pdf-overlay");
    const frame = document.getElementById("pdf-frame");
    frame.src = ""; // reset biar berhenti load PDF
